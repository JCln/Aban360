...
const Page = () => {
  ...
  const onSubmit = (data: any) => {
    const zoneId = Object.keys(data)
      .filter(key => key.startsWith('check_zoneId'))
      .reduce((acc, key) => {
    ...
    const endpointId = Object.keys(data)
  ...
  return (
    <DefaultLayout>
      <div className="user-create-page container mx-auto">
        <Breadcrumb items={[{ href: path.management, label: "مدیریت" }, { href: path.userManagement, label: "مدیریت  کاربران" }, { label: "افزودن کاربر" }]} />
