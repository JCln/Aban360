...
import { deleteUser, fetchUsers, updateUser } from '../../../api/User';
  ...
  return (
    <DefaultLayout>
      <div className="management-page container mx-auto">
        ...
        <Breadcrumb items={[{ href: path.management, label: "مدیریت" }, { href: path.userManagement, label: "مدیریت کاربران" }, { label: "مشاهده همه " }]} />
        <div className="p-6 bg-white rounded-md content">
          ...
          {/* {deleteDialog && selectId && (
            <DeleteConfirmation show={deleteDialog} handleClose={() => setDeleteDialog(false)} apiFunction={deleteUser} id={selectId} />
          )} */}
          ...
          <DatailGridComponent
            ...
            columns={[
              ...
              // },
              {
                ...
                renderCell: (cellValues: any) => {
                  const onClick = (e: any) => {
                    navigate(path?.userEdit + cellValues?.row?.id)
                  };
                  return (
