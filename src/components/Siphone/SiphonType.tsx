...
import { createSiphonType, deleteSiphonType, fetchSiphonType, updateSiphonType } from '../../api/Siphon/index';
    ...
    return (
        <div style={{ height: 750, width: "100%" }}>
            <ActionBar
                ...
                title={"ایجاد نوع سیفون"}
                apiFunction={createSiphonType}
            />
            {open && <EditComponent
                formConfig={formData}
                title={"ویرایش"}
                handleClose={() => setOpen(!open)}
                apiFunction={updateSiphonType}
                open={open}
            />}
