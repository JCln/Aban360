    ...
    return (
        <div style={{ height: 750, width: "100%" }}>
            <ActionBar
                ...
                title={"ایجاد کاربری"}
                apiFunction={createUsage}
            />
            {open && <EditComponent
                formConfig={formData}
                title={"ویرایش"}
                handleClose={() => setOpen(!open)}
                apiFunction={updateUsage}
                open={open}
            />}
            ...
            <DatailGridComponent
                ...
                columns={[
                    ...[ID(10), TITLE(400),
                    { field: "provienceId", headerName: "", width: 10 },
                    { field: "estateUsageConsumtions", headerName: "", width: 10 },
                    { field: "estateUsageSells", headerName: "", width: 10 },
                    ],
                    {
                        field: "edit",
                        headerName: "",
                        ...
                        renderCell: (cellValues: any) => {
                            const onClick = (e: any) => {
                                ...
                                { name: 'provinceId', class: "col-span-12 xl:col-span-4", label: 'استان', type: 'select', options: _province ?? [], defaultValue: _province?.find(v => v.id === cellValues?.provinceId) },
