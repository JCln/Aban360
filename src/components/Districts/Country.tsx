...
import { createCountry, deleteCountry, fetchCountry, updateCountry } from "../../api/Districts";
import EditComponent from '../Form/EditComponent';
import DeleteConfirmation from '../Common/DeletConfirmation';
export const useCountry = () => useQuery("country", fetchCountry);
    ...
    return (
        <div style={{ height: 750, width: "100%" }}>
            ...
            {open && <EditComponent
                ...
                apiFunction={updateCountry}
                open={open}
            />}
            {deleteDialog && selectId && (
                <DeleteConfirmation show={deleteDialog} handleClose={() => setDeleteDialog(false)} apiFunction={deleteCountry} id={selectId} />
            )}
            <DatailGridComponent
