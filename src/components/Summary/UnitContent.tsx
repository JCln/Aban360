...
import { fetchUnitInfo } from '../../api/summary/index';
...
const UnitContent = (props) => {
    ...
    useEffect(() => {
        setLoading(true)
        fetchUnitInfo({ input: input }).then(res => {
            setRows(res.data)
        }).catch(error => {
            console.log(error)
        })
    ...
    return (
        <>
            ...
            <DataGridComponent
                ...
                columns={[
                    ...[ID(20),
                    { field: "postalCode", headerName: "کد پستی", width: 150, headerAlign: "center", align: "center" },
                    { field: "storey", headerName: "طبقه", width: 180, headerAlign: "center", align: "center" },
                    { field: "description", headerName: "توضیحات", width: 350, headerAlign: "center", align: "center" },
                    ],
                    {
                        field: "edit",
                        headerName: "",
