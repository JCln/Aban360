...
import { FATHERNAME, FULLNAME, ID, modulePermissions } from '../Table/Columns';
...
import { fetchOwnerInfo } from '../../api/summary/index';
export const useModule = () => useQuery("module", fetchAllModule);

const ProprietorContent = (props) => {
    const { input } = props
    ...
    return (
        <>
            ...
            <DataGridComponent
                key={"ProprietorContentSummary"}
                // handlePageSizeChange={handlePageSizeChange}
                columns={[
                    ...[ID(20), FULLNAME(170), FATHERNAME(170),
                    { field: "nationalId", headerName: "کدملی", width: 180, align: "center", headerAlign: "center", sortable: true },
                    { field: "mobileNumbers", headerName: "تلفن همراه", width: 200, align: "center", headerAlign: "center", sortable: true },
                    { field: "phoneNumbers", headerName: "تلفن ثابت", width: 220, align: "center", headerAlign: "center", sortable: true },
                    ],
                    {
                        field: "edit",
                        headerName: "",
...
export default ProprietorContent